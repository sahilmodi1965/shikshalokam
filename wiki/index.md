...
Auto-injected at every session start. Budget ≤ 1,500 tokens (per `TOKEN_BUDGET.md`). Lazily drill into specific files via wikilink.

## Concepts (what we think)

- [[concepts/mission]] — *user-validated.* ShikshaLokam exists to enable Shikshagraha — strengthening India's 1M public schools. Co-builders of DIKSHA national education platform.
